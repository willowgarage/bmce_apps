...
if __name__ == '__main__':
    ...
    goal = DeliverGoal()
    # Fill in goal here.
    goal.get_object_pose = pose_from_yaml('get_object_pose.yaml')
    goal.give_object_pose = pose_from_yaml('give_object_pose.yaml')
    goal.return_home_pose = pose_from_yaml('return_home_pose.yaml')
